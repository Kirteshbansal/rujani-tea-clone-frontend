...
import { Box, Flex, Heading, Image, Stack, Text, Icon, FormControl, FormLabel, Input, Button } from "@chakra-ui/react";
...
class Checkout extends Component {
    ...
    handleAddress = async (e) => {
        try {
            ...
            const addr = {
                id: id,
                addr1: this.state.addr1.length > 0 ? this.state.addr1 : user.address.addr1,
                addr2: this.state.addr2.length > 0 ? this.state.addr2 : user.address.addr2,
                city: this.state.city.length > 0 ? this.state.city : user.address.city,
                state: this.state.state.length > 0 ? this.state.state : user.address.state,
                ...
                <Flex justifyContent="center" boxShadow="sm">
                    <Box w="50%" pl={30} py={45} bg="#fafafa">
                        <Stack ml="18%" flexDirection="column" pl={35} pr={20}>
                            <Heading as="h1" fontSize={26} fontWeight="400" alignSelf="center">
                                <Link to="/">Rujani tea India</Link>
                            </Heading>
                            <Heading as="h2" fontSize={19} color="#444444" fontWeight="400" mt={35}>
                                Contact information
                            </Heading>
                            ...
                            <Flex alignItems="center" mt={2} border="1px" borderColor="#ccc" p={2}>
                                <Icon as={RiCheckboxCircleFill} size={6} color="var(--nero-black)" mr={5} />
