                ...
                {Object.entries(user).length > 0 && (
                    <Layout showHeader={true} showFooter={true} errorBoundary={true}>
                        <Stack bg="#efefef" px="15%" py="3%">
                            ...
                            <Text mt={5} fontSize={13} letterSpacing={1} fontWeight="sm" color="var(--nero-black)">
                                Welcome back,
                            ...
                            <Flex mt={55} justifyContent="space-between">
                                ...
                                <Stack w="30%">
                                    ...
                                    <Box borderBottom="1px" borderBottomColor="#ccc" mt={3}></Box>
                                    <Text fontSize={14} mt={3}>{`${user.firstName} ${user.lastName}`}</Text>
                                    <Text fontSize={14}>{`${user.address?.addr1}`}</Text>
                                    <Text fontSize={14}>{`${user.address?.addr2}`}</Text>
                                    <Text fontSize={14}>{`${user.address?.city} ${user.address?.state}`}</Text>
                            ...
                            <Modal isOpen={this.state.isOpen} onClose={this.onClose} size="xl">
                                <ModalOverlay />
                                <ModalContent w={{ base: "100%", md: "50%" }}>
                                    <ModalHeader textAlign="center" mt={3}>
                                        MANAGE YOUR ADDRESS
                                    </ModalHeader>
                                    <ModalCloseButton mt={3} mr={2} outline="none" _focus={{ outline: "none" }} />
                                    <ModalBody>
